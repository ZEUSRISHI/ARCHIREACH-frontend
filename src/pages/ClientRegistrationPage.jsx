  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#ECEBFB' }}>
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-80px)]">
        {/* Left Side - Image */}
        <div className="lg:w-1/2 p-8 lg:p-12 flex items-center justify-center" style={{ backgroundColor: '#ECEBFB' }}>
        ...
        <div className="lg:w-1/2 p-6 lg:p-8 flex flex-col justify-center">
          <div className="w-full max-w-sm bg-white rounded-lg shadow-lg p-6 lg:p-8">
            ...
            <p className="text-gray-700 mb-6">Create your account to get started</p>
